...
We often hear devs out there suggesting switching from JSON to Protocol Buffers for "performance". What is the real performance gain? What are the other considerations to take into account? Play with the interactive comparison below first, then read on if you're curious about the why.

## 1. Play with it

Drag the **records** and **repetition** sliders below to explore the four scenarios across payload sizes. Move the **records** slider to 1 to see Gzip's overhead on tiny payloads. Use the **repetition** slider to control how repetitive the string fields are — watch what it does to the Gzip bars (Protobuf is barely affected).
...
If you played with the sliders above, you probably noticed:
